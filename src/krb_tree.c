...
/* Some order functions used very frequently. */

/* This function returns the relative order of two pointers. */
int krb_tree_cmp(void *key_1, void *key_2) {
    if (key_1 < key_2) return -1;
    if (key_1 > key_2) return 1;
    return 0;
}

/* This function returns the relative order of two integers. */
int krb_tree_int_cmp(void *key_1, void *key_2) {
    int *int_1 = (int *) key_1;
    int *int_2 = (int *) key_2;
    if (*int_1 < *int_2) return -1;
    if (*int_1 > *int_2) return 1;
    return 0;
}

/* This function returns the relative order of two uint64_t. */
int krb_tree_uint64_cmp(void *key_1, void *key_2) {
    uint64_t *int_1 = (uint64_t *) key_1;
    uint64_t *int_2 = (uint64_t *) key_2;
    if (*int_1 < *int_2) return -1;
    if (*int_1 > *int_2) return 1;
    return 0;
}

/* This function returns the relative order of two C strings. */
int krb_tree_str_cmp(void *key_1, void *key_2) {
    char *k1 = (char *) key_1;
    char *k2 = (char *) key_2;
    return strcmp(k1, k2);
}
